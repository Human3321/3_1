...
void name_print(FILE* n,int count)
{
...
void printf_item(FILE* n,char input)
{
	if(input=='a')
		fprintf(n,"%s","BOMB: ");	
	else if(input=='b')
...
void check_error(FILE* wp,char input1,char input2,int* star_count,int* friend_count,int* set_count)
{
	if(input1=='@')
	{
	...
	else if(input1=='a'||input1=='b'||input1=='c'||input1=='d'||input1=='e'||input1=='f')
		printf_item(wp,input1);
	else
	{	
		if(input1=='\n'&&(*star_count)==3&&(input2!='@'))
		{
